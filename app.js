...
const liveUserFormRouter = require("./routes/liveUserFormRoute");
...
var whitelist = ["http://localhost:3000", "https://front-end-development-f5b8.up.railway.app", "https://lirmusic.com", "https://livex.lirmusic.com", "https://www.lirmusic.com"]
const corsOptions = {
    origin: whitelist,
    credentials: true,
...
app.use("/api/v1/liveUserForm", liveUserFormRouter);
